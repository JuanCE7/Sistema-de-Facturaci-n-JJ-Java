...
public class ConstructorAlerta {
    ...
    public static void create(TipoAlerta type, StackPane dialogContainer, Node nodeToBlur, Node nodeToDisable, String body) {
        setFunction(type);
        ...
        nodeToBlur.setEffect(constantes.EFECTO_BOX_BLUR);
    ...
    private static void setFunction(TipoAlerta type) {
        switch (type) {
            case SUCCES:
                title = "Éxito!";
